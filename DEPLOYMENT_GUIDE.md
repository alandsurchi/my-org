...
5. **Add Environment Variables**:
   ```bash
   railway variables set MONGODB_URI="mongodb+srv://alandsurchi456:LKGdcGLn8Ff6co0N@cluster2.tqyiib8.mongodb.net/charity-dashboard?retryWrites=true&w=majority&appName=Cluster2"
...
3. **Set Environment Variables**:
   ```bash
   heroku config:set MONGODB_URI="mongodb+srv://alandsurchi456:LKGdcGLn8Ff6co0N@cluster2.tqyiib8.mongodb.net/charity-dashboard?retryWrites=true&w=majority&appName=Cluster2"
