...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-br from-gray-50 dark:from-gray-950 via-blue-50/30 dark:via-gray-950 to-purple-50/20 dark:to-gray-950 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="fade-in-on-scroll">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed font-light mb-8" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.05)' }}>
                {t('aboutDescription')}
              </p>
            </div>
          </div>
