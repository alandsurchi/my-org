    ...
    <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4">
        ...
        <div className="mb-8 fade-in-on-scroll">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full glass animate-glow mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center fade-in-on-scroll">
          <Button 
            size="lg" 
            className="px-10 py-4 text-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-full shadow-2xl hover-lift animate-glow border-0"
          >
            Join Our Mission
          </Button>
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="px-10 py-4 text-lg glass border-white/30 text-white hover:bg-white/10 rounded-full shadow-xl hover-lift"
          >
            Learn More
          </Button>
        </div>
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 fade-in-on-scroll">
          <button
