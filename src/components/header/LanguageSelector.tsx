...
const LanguageSelector: React.FC<LanguageSelectorProps> = ({ getSelectStyling }) => {
  ...
  return (
    <Select value={language} onValueChange={(value) => setLanguage(value as Language)}>
      <SelectTrigger aria-label="Language" className={`w-auto min-w-[80px] sm:min-w-[100px] transition-all duration-300 hover:scale-105 touch-manipulation ${getSelectStyling()}`}>
