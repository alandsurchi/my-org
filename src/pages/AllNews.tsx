            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredNews.map((newsItem, index) => (
                <div key={newsItem.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                  <img 
                    src={newsItem.image_url || 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&h=250&fit=crop'} 
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-3">{newsItem.title_en}</h3>
                    <p className="text-gray-600 mb-4 line-clamp-3">{newsItem.description_en}</p>
                    <Button 
